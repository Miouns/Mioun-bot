...
exports.run = async (client, message, args) => {
  let user = message.mentions.users.first();
    ...
    if(!message.member.hasPermission("KICK_MEMBERS")) return message.channel.send(`You Require \`KICK MEMBER\` Permission to Execute this Command`)
...
exports.help = {
  ...
  usage: "kick @Mioun Not read rules",
  example: "mi.kick @Mioun Not read Rules"
}
